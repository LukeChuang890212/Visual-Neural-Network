...
#%%
    ...
    def obj2_to_output(self,classname):   
        ...
        classname.output_arr = (self.two_d_softmax(classname.obj2(classname.obj2_arr, "Output")+Cascade.bias)*(1-classname.cascade_rate)+classname.output_arr*classname.cascade_rate)
